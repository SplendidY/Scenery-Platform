  ...
  >
    ...
    >
      <el-sub-menu index="1">
        ...
        <el-menu-item index="1-1" @click="tfecharts(1)"
          >浙江省各地级市3A级以上景区数量总表</el-menu-item
        >
        <el-menu-item index="1-2" @click="tfecharts(2)"
          >浙江省各地级市3A级以上景区数量分表</el-menu-item
        >
        <el-menu-item index="1-3"
          ...
          ></el-input>
          <el-button
            style="position: relative; left: 10px; width: 80px"
            type="primary"
            @click="closeecharts"
          ...
          <template v-if="closestSpots.length > 0">
            <div>
              <p
                ...
                @click="routetospot(closestSpots[0])"
              >
                {{ closestSpots[0] }}
              </p>
            </div>
        ...
        <el-menu-item index="2-2">
          <template v-if="closestSpots.length > 0">
            <div>
              <p
                style="margin: 0; cursor: pointer"
                @click="routetospot(closestSpots[1])"
              >
                {{ closestSpots[1] }}
              </p>
            </div>
        ...
        <el-menu-item index="2-3">
          <template v-if="closestSpots.length > 0">
            <div>
              <p
                style="margin: 0; cursor: pointer"
                @click="routetospot(closestSpots[2])"
              >
                {{ closestSpots[2] }}
              </p>
            </div>
      ...
      <el-footer style="padding: 0; width: 100%">
        ...
        >
          ...
          <el-sub-menu index="1">
            ...
            <el-sub-menu index="1-1">
              ...
              <el-menu-item index="1-1-1" @click="SwitchLayer('1-1-1')"
                >默认openstreetmap底图</el-menu-item
              >
              <el-menu-item index="1-1-2" @click="SwitchLayer('1-1-2')"
                >黑夜</el-menu-item
              >
              <el-menu-item index="1-1-3" @click="SwitchLayer('1-1-3')"
                >白天</el-menu-item
              >
            </el-sub-menu>
          ...
          <el-menu-item index="2"
            ...
            <!-- 滚动栏 -->
            <el-scrollbar
              v-if="filteredLocations.length && isFocused"
              style="
                height: 300px;
                width: 300px;
                position: absolute;
            ...
            <el-input
              ...
              @blur="handleBlur"
              placeholder="输入目的地景区名称"
            ></el-input>
            <el-button style="margin-left: 10px" type="primary" @click="getjw"
              ><el-icon><Position /></el-icon>导航</el-button
            >
          </el-menu-item>
        </el-menu>
        <!-- 用户头像 -->
        <div style="position: absolute; right: 3%; bottom: 1.5%">
          ...
          <el-button
            ...
            ><el-icon style="position: relative; right: 10px"
        ...
        <div style="background-color: #ffffff; padding: 2px, 2px, 3px, 2px">
          ...
          <div>
            ...
            <el-button type="primary" style="position: relative; left: 10px">
              Upload<el-icon class="el-icon--right" @click="submitComment"
                ><Upload
              /></el-icon>
            </el-button>
          </div>
    ...
    >
      <template v-if="closestSpots.length > 0">
        <div
          v-for="(spot, index) in closestSpots"
          :key="index"
          class="drawer5-item"
          style="
            display: flex;
          ...
          "
        >
          <p style="margin: 0; cursor: pointer" @click="routetospot(spot)">
            {{ spot }}
          </p>
        </div>
      </template>
...
const tfdrawer4 = () => {
  try {
    ...
    if (searchName) {
      search_closest_spots(searchName)
        .then(() => {})
        .catch((error) => {
